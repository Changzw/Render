...
-(void)setupRenderBuffer {
  ...
  //5.将可绘制对象drawable object's CAEAGLLayer 的存储绑定到OpenGL ES renderBuffer对象
...
-(void)deleteRenderAndFrameBuffer{
  /*
   ...
   frame buffer object即称FBO(渲染缓冲区对象)。
   render buffer 则又可分为3类。colorBuffer、depthBuffer、stencilBuffer。
   */
...
//2.设置上下文
-(void)setupContext {
  //1.指定OpenGL ES 渲染API版本，我们使用2.0创建图形上下文
